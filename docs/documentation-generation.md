...
| Component page                | `<ComponentName>`, below `Components (<SystemName>)` | The latest version flows of one component. The table is rendered directly on this page; no flow or `Version Flows` child pages are created. |
